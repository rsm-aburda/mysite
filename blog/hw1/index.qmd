...
# Print basic info (goes to console/log, not HTML)
print("=== Data Overview ===")
print(df.info())
...
```{python, engine="python", echo=false}
# Create 'gave' as a binary outcome: 1 if donation made, else 0
df['gave'] = (df['amount'] > 0).astype(int)

# Create a ratio1 dummy (1:1 match is the baseline group)
